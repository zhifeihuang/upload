...
class xssClean {
	...
	public function check( $input, $safe_level = 0, $is_image = false ) {
	
		if ($is_image) {
			/*
			*	copy from CodeIgniter file=Upload.php
			*/
			...
			return ! preg_match('/<(a|body|head|html|img|plaintext|pre|script|table|title)[\s>]/i', $input);
		}
